...
class DecisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create decision" do
    assert_difference("Decision.count") do
      post decisions_url, params: { decision: { input: @decision.input, input_type: @decision.input_type, project_id: @decision.project_id, result: @decision.result } }
    end
  ...
  test "should update decision" do
    patch decision_url(@decision), params: { decision: { input: @decision.input, input_type: @decision.input_type, project_id: @decision.project_id, result: @decision.result } }
